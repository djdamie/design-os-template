# Data Model Input for Design OS

Use this content when running `/data-model` in Design OS.

---

## Core Entities

When Design OS asks about your data model, describe these entities:
...
After running `/data-model`, Design OS should create `product/data-model/data-model.md` with:
- Entity names and descriptions
- All 6 Brief sections with their fields
- Relationships between entities
- Classification and completeness rules
